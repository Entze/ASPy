...
class TestConstructiveUnification(unittest.TestCase):
    ...
    def test_var_var_positive(self):
        ...
        expected = (CoinductiveHypothesisSet(bindings={var1: {var2}, var2: {var1}}, prohibited={var1: set(), var2: set()}),)
        self.assertEqual(expected, actual, msg="\nExpected: {}\n  Actual: {}\n".format(expected, actual))
    ...
    def test_var_var_bound_positive(self):
        ...
        chs = CoinductiveHypothesisSet(bindings={var1: {Term.zero()}, var2: {Term.one()}})
        actual = chs.constructive_unification(var1, var2)
        expected = (CoinductiveHypothesisSet(bindings={var1: {Term.zero(), var2}, var2: {Term.one(), var1}}, prohibited={var1: set(), var2: set()}),)
        self.assertEqual(expected, actual)
    ...
    def test_var_var_partiallybound1_positive(self):
        ...
        actual = chs.constructive_unification(var1, var2)
        expected = (CoinductiveHypothesisSet(bindings={var1: {Term.zero(), var2}, var2: {var1}}, prohibited={var1: set(), var2: set()}),)
        self.assertEqual(expected, actual)
    ...
    def test_var_var_partiallybound2_positive(self):
        ...
        actual = chs.constructive_unification(var1, var2)
        expected = (CoinductiveHypothesisSet(bindings={var1: {var2}, var2: {Term.zero(), var1}}, prohibited={var1: set(), var2: set()}),)
        self.assertEqual(expected, actual)
    ...
    def test_var_var_prohibited_positive(self):
        ...
        chs = CoinductiveHypothesisSet(prohibited={var1: {Term.zero()}, var2: {Term.one()}})
        actual = chs.constructive_unification(var1, var2)
        expected = (CoinductiveHypothesisSet(bindings={var1: {var2}, var2: {var1}}, prohibited={var1: {Term.zero(), Term.one()}, var2: {Term.zero(), Term.one()}}),)
        self.assertEqual(expected, actual)
    ...
    def test_var_var_prohibitedpartially1_positive(self):
        ...
        actual = chs.constructive_unification(var1, var2)
        expected = (CoinductiveHypothesisSet(bindings={var1: {var2}, var2: {var1}}, prohibited={var1: {Term.zero()}, var2: {Term.zero()}}),)
        self.assertEqual(expected, actual)
